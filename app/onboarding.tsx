...
const pages = [
  { icon: '🛡️', title: 'Welcome to Custorian', body: 'A safety tool that helps protect your child from online threats — grooming, bullying, self-harm signals, and violence.' },
