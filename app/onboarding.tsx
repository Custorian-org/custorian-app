...
const s = StyleSheet.create({
  ...
  body: { fontSize: 14, color: '#6b7280', textAlign: 'center', lineHeight: 21, maxWidth: 300, marginBottom: 32 },
  bodySmall: { fontSize: 13, color: '#6b7280', lineHeight: 19, marginBottom: 24 },
  ...
  agePill: { paddingHorizontal: 16, paddingVertical: 8, borderRadius: 100, backgroundColor: '#f3f4f6' },
  agePillActive: { backgroundColor: '#7c3aed' },
  agePillText: { fontSize: 13, fontWeight: '600', color: '#6b7280' },
