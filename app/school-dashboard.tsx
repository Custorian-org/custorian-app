...
const DEMO_RECOMMENDATIONS = [
  ...
  },
  {
    ...
    action: 'Custorian data suggests screen time averaging 5.2hrs/day. Plan offline activity week.',
    priority: 'low',
  },
];
...
const styles = StyleSheet.create({
  ...
  subtitle: { fontSize: 14, color: Colors.textDim, marginTop: 4, marginBottom: 20 },
  periodRow: { flexDirection: 'row', marginBottom: 20 },
  periodChip: { paddingHorizontal: 16, paddingVertical: 8, borderRadius: 20, backgroundColor: Colors.card, borderWidth: 1, borderColor: Colors.border, marginRight: 8 },
  ...
  metricCard: { width: '48%', backgroundColor: Colors.card, borderRadius: 12, padding: 16, margin: '1%', alignItems: 'center', shadowColor: '#000', shadowOpacity: 0.05, shadowRadius: 4, elevation: 1 },
  metricIcon: { fontSize: 24, marginBottom: 4 },
  metricCount: { fontSize: 28, fontWeight: 'bold' },
  metricLabel: { fontSize: 11, color: Colors.textDim, textAlign: 'center', marginTop: 4 },
  metricTrend: { fontSize: 11, color: Colors.textDim, marginTop: 2 },
  sectionTitle: { fontSize: 18, fontWeight: 'bold', color: Colors.text, marginBottom: 12, marginTop: 8 },
  alertCard: { backgroundColor: Colors.card, borderRadius: 12, padding: 16, marginBottom: 8, borderLeftWidth: 4, borderLeftColor: '#ddd' },
  alertMessage: { fontSize: 14, color: Colors.text, lineHeight: 20 },
  alertTime: { fontSize: 11, color: Colors.textDim, marginTop: 6 },
  recCard: { backgroundColor: Colors.card, borderRadius: 12, padding: 16, marginBottom: 8 },
  ...
  recAction: { fontSize: 13, color: Colors.textDim, lineHeight: 18 },
  exportButton: { backgroundColor: Colors.card, borderRadius: 12, padding: 16, alignItems: 'center', marginTop: 12, borderWidth: 1, borderColor: Colors.primary },
