...
const s = StyleSheet.create({
  ...
  subtitle: { fontSize: 13, color: '#6b7280', textAlign: 'center', marginTop: 4, lineHeight: 18, maxWidth: 280 },
  input: { backgroundColor: '#f9fafb', borderWidth: 1, borderColor: '#e5e7eb', borderRadius: 14, padding: 16, fontSize: 15, minHeight: 100, color: '#1a1a2e', marginBottom: 12, lineHeight: 22 },
  ...
  tellParent: { backgroundColor: '#fef2f2', borderRadius: 14, padding: 18, alignItems: 'center', borderWidth: 1, borderColor: '#fecaca', marginBottom: 16 },
  tellParentText: { fontSize: 14, fontWeight: '700', color: '#dc2626', marginBottom: 4 },
  tellParentHint: { fontSize: 11, color: '#991b1b' },
  encouragement: { backgroundColor: '#f0fdf4', borderRadius: 14, padding: 18, alignItems: 'center', borderWidth: 1, borderColor: '#bbf7d0' },
  encouragementText: { fontSize: 13, color: '#166534', textAlign: 'center', lineHeight: 19, fontWeight: '500' },
  privacy: { fontSize: 10, color: '#9ca3af', textAlign: 'center', lineHeight: 15, marginTop: 16 },
});
