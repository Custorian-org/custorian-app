...
const styles = StyleSheet.create({
  ...
  body: { fontSize: 16, textAlign: 'center', color: Colors.textDim, lineHeight: 24, marginBottom: 24 },
  tipsCard: { backgroundColor: Colors.card, borderRadius: 16, padding: 20, width: '100%', marginBottom: 20, shadowColor: '#000', shadowOpacity: 0.05, shadowRadius: 8, elevation: 2 },
  ...
  crisisSubtext: { fontSize: 12, color: Colors.textDim, marginTop: 4 },
